...
def simulate(x0=0.0, v0=2.0, t_end=10.0, n_points=101):
    """数值积分自由质点，返回 (t, x, v) 序列。
...
if __name__ == "__main__":
    x0, v0, t_end = 0.0, 2.0, 10.0
    t, x_num, v_num = simulate(x0=x0, v0=v0, t_end=t_end)

    # 解析解对照
    x_ana, v_ana = analytical(t, x0, v0)
    ...
    print(f"末点数值 v    : {v_num[-1]:.6f}（应恒等于 v0 = {v0}）")
